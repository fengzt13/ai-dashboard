...
window.AIDATA['business'] = {
  ...
  "openai": {
    ...
    "arr_now": "$400亿+",
    "arr_time": "2026-08",
    "arr_mom": "+12%（7月$400亿→8月估$450亿）",
    "arr_qoq": "+60%（Q1末$250亿→Q2末$400亿）",
    "arr_yoy": "+233%（2025.07 $120亿→2026.07 $400亿）",
    "q2_2026_revenue": "$67亿",
    "q1_2026_revenue": "$57亿",
  ...
  "grok": {
    ...
    "arr_timeline": [
      ...
      { "date": "2026-07", "arr": 20, "note": "目标 $20亿" }
    ]
  },
  "profit_comparison": {
  ...
  "others": {
    "coreweave": { "name": "CoreWeave", "metric": "Q2 营收 $25.8亿 / 在手订单 $1,040亿" },
...
window.AIDATA['compute'] = {
  ...
  "gpu_price_us": [
    { "gpu": "H100（1年期合约）", "price": "$2.35/GPU小时", "change": "+40%（自2025.10低点）", "mom": "持平（高位维持）", "qoq": "+0%（Q2以来稳定$2.35）", "yoy": "+12%（2025.08 ~$2.1→2026.08 $2.35）", "time": "2026H1", "source": "Silicon Data" },
    ...
    { "gpu": "B200（现货租赁）", "price": "—", "change": "2个月涨48%", "mom": "+19%（7月124→8月148）", "qoq": "+48%（2个月）", "yoy": "N/A（新品）", "time": "2026.08", "source": "Silicon Data" },
  ...
  "gpu_price_history": {
    ...
    "points": [
      ...
      { "date": "2026-08", "price": 2.35, "note": "最新" }
    ]
  },
  "b200_price_history": {
  ...
  "compute_futures": {
    "status": "CME 算力期货 10月5日 NYMEX 挂牌（待 CFTC 批准）",
...
window.AIDATA['macro'] = {
  ...
  "industry_dimensions": [
    { "dim": "需求景气度", "status": "历史峰值", "detail": "全球 Token 周调用量 93.3万亿，2年增长9000倍，Agent 工作负载成核心增量" },
    { "dim": "供给紧张度", "status": "全面紧张", "detail": "H100 +40%、B200 +48%；美国75个 AIDC 项目受阻；HBM 存储超级周期" },
    { "dim": "算力成本趋势", "status": "不降反升", "detail": "GPU 租赁价反弹、电力成最大瓶颈、算力期货10月挂牌金融化启动" },
    { "dim": "行业营收增速", "status": "加速分化", "detail": "头部公司 ARR 合计突破 $1,000亿，企业 API 模式跑通盈利，C 端订阅模式仍烧钱" },
    { "dim": "资本投入力度", "status": "史无前例", "detail": "$3.1万亿表外承诺、$16万亿涌入 AIDC、AI 资本开支首次超油气" },
  ...
  "bottlenecks": [
    ...
    { "type": "GPU 供给", "status": "H100 涨40%，B200 现货涨48%", "impact": "推理成本上升" },
  ...
  "trend_signals": [
    ...
    { "trend": "算力金融化", "signal": "CME 10月推出算力期货（H100+B200）", "support": "CME SER-9785" },
    { "trend": "Token 经济性价比化", "signal": "支出指数停滞/回落，企业回归理性消耗", "support": "Silicon Data" },
    { "trend": "行业首次实现盈利", "signal": "Anthropic Q2 调整后盈利 $5.59亿", "support": "公司披露" },
    { "trend": "算力供给紧张持续", "signal": "CoreWeave $1,040亿在手订单", "support": "财报" },
    { "trend": "AI Capex 加速", "signal": "$16万亿涌入 AIDC，表外承诺 $3.1万亿", "support": "行业统计" },
  ...
  "conclusions": [
    "AI 行业需求仍处爆发式增长，景气度处于历史峰值：Token 调用量指数级攀升，Agent 工作负载是核心增量引擎",
    "Token 单价进入下降通道，行业进入'以量补价'阶段：模型竞争+开源低价压低单位收入，但用量增速远超价降，总支出仍扩张",
    "算力供给紧张加剧而非缓解：GPU 价格全面上涨，电力成最大瓶颈，推理成本下行不及预期",
...
window.AIDATA['output'] = {
  ...
  "key_metrics": {
    ...
    "annual_spend_yoy": "+1000%（2025.03 $0.3→2026.08 $12亿/月）",
    "models_count": "90+",
  ...
  "ecosystem": {
    "china": {
      "weekly": "40.48万亿",
      "models": ["DeepSeek-V4", "Kimi K3 (2.8万亿参数)", "Qwen3.8-Max (2.4万亿)", "GLM-5.2", "MiMo-V2.5"],
      "open_source": "旗舰级全量开源（全球最大开源模型 Kimi K3）",
      "trend": "调用量持续上升（+9.88% WoW）"
    },
    "us": {
      "weekly": "9.66万亿",
...
window.AIDATA['overview'] = {
  ...
  "key_metrics": [
    { "label": "全球周 Token 调用量", "value": "93.3万亿", "sub": "环比 +23.9%", "mom": "+37%", "qoq": "+86%", "yoy": "+522%", "delta": "up", "page": "token" },
    { "label": "Anthropic ARR", "value": "$650亿", "sub": "首次单季盈利 $5.59亿", "mom": "+18%", "qoq": "+242%", "yoy": "+1500%", "delta": "up", "page": "business" },
    { "label": "OpenAI ARR", "value": "$400亿+", "sub": "Q2 亏损 $123亿", "mom": "+12%", "qoq": "+60%", "yoy": "+233%", "delta": "down", "page": "business" },
    { "label": "H100 租赁价（美国）", "value": "$2.35/h", "sub": "较 2025.10 低点 +40%", "mom": "持平", "qoq": "+0%", "yoy": "+12%", "delta": "up", "page": "compute" },
  ...
  "conclusions": [
    { "title": "AI 行业需求持续爆发，景气度处于历史峰值", "desc": "全球 Token 周调用量 2 年增长 9000 倍，Agent 工作负载成为核心增量引擎，行业需求侧未见放缓迹象。" },
    { "title": "Token 单价进入下降通道，行业进入「以量补价」阶段", "desc": "Silicon Data 支出指数停滞回落，模型竞争加剧 + 开源低价，单位 Token 收入承压，靠用量增长弥补。" },
    { "title": "算力供给全面紧张，成本不降反升", "desc": "H100 租赁价较低点反弹 40%、B200 现货涨 48%；电力成为最大瓶颈；算力期货 10 月挂牌标志金融化启动。" },
    { "title": "行业商业模型分化加速：企业 API 跑通盈利，C 端订阅仍烧钱", "desc": "Anthropic Q2 首次单季盈利 $5.59亿（企业 API 模式），OpenAI Q2 亏损 $123亿（C 端订阅模式），商业效率差距拉大。" },
  ...
  "timeline": [
    ...
    { "date": "2026-08", "event": "全球周 Token 93.3万亿；CME 算力期货细则发布" }
  ],
  "sources": [
    "OpenRouter 公开数据",
...
window.AIDATA['token'] = {
  ...
  "model_ranking": [
    { "rank": 1, "model": "DeepSeek-V4-Flash", "vendor": "DeepSeek", "country": "中国" },
    { "rank": 2, "model": "MiMo-V2.5", "vendor": "小米", "country": "中国" },
    { "rank": 3, "model": "Hy3", "vendor": "腾讯", "country": "中国" },
    { "rank": 4, "model": "DeepSeek-V4-Pro", "vendor": "DeepSeek", "country": "中国" },
    { "rank": 5, "model": "GLM-5.2", "vendor": "智谱", "country": "中国" }
  ],
  "agent_trend": {
    "desc": "自2026年2月起，智能体(Agent)产生的 Token 占比快速攀升，成为增长核心引擎。工作负载从单次对话转向持续运行的多步骤任务。",
    "milestones": [
      ...
      { "date": "2026-02", "event": "中国模型周调用量首次超越美国" },
      { "date": "2026-08", "event": "全球周调用量 93.3 万亿 Token，2年增长9000倍" }
    ]
  }
};
